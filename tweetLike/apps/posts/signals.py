...
from tweetLike.apps.core.utils import generate_random_string

from .models import Post

@receiver(pre_save,sender=Post)
def add_slug_to_post_if_not_exists(sender,instance,*args,**kwargs):
    ...
    if instance and not instance.slug:
        ...
        while len(slug+ '-' + unique) > MAXIMUM_SLUG_LENGTH:
            ...
            if len(parts) is 1:
                ...
                # arbitraryly remove 'len(unique)' characters from the end of 
                # 'slug'. Substract one to account for extra hyphen.
