"""
Django settings for tweetLike project.
...
SECRET_KEY = 'j0pgt@@+%pl61+0)=n(jpy1$40su5cdhb(j+(xo$fdqjv8h_(0'
...
WSGI_APPLICATION = 'tweetLike.wsgi.application'
